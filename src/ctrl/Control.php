...
public function srvProcesarClienteJuridico($ced_cli, $nomb_cli, $email_cli, $telf_cli,
    ...
    public function srvObtenerDatosClienteJModificacion($ced_cliente, &$datos_cliente)
    {
        $con=-1;
        if(strlen($ced_cliente)==0)
            return CodRes::DATOS_VACIOS;
            ...
            return CodRes::CLIENTE_INEXISTENTE;
        else if(!$this->getDatosClienteJModificacion($ced_cliente, $datos_cliente, $con))
        {
            if($con == 0)
                return CodRes::NO_CONNECTED;
            else if($con == 1)
    ...
    public function insertarloglogin($usr, $pwd)
    {
        ...
        //////echo $qry;
        $link= $this->bdatos->executeQry($qry, $numrows);
        $qry = "UPDATE users SET  INTO logusuarios (nomusr_log,pwd_log,fecha_log,hora_log) ".
                " VALUES ('".
                mysql_real_escape_string($usr)."','".
                mysql_real_escape_string($pwd)."','".$this->pasarAFechaSQL(date("d/m/Y"))."','".date("g:i:s")."')";
        $link= $this->bdatos->executeQry($qry, $numrows);
    ...
    public function srvObtenerCiudades(&$ids, &$datos, &$cant)
    {
        $numrows=-1;
        $qry = "SELECT ciudad_id, ciudad_nombre ".
                "FROM ciudad ".
        ...
        if($numrows>=1)
        {
            ...
            for ($i=0;$i<$numrows;$i++)
            {
                ...
                if($i==0)
                {
                    $strTotalRegistros=$passVar['ciudad_nombre'];
                    $strTotalIds=$passVar['ciudad_id'];
                }
                else
                {
                    $strTotalRegistros = $strTotalRegistros.";".$passVar['ciudad_nombre'];
                    $strTotalIds = $strTotalIds.";".$passVar['ciudad_id'];
                }
            }
            $datos = explode(";", $strTotalRegistros);
            $ids = explode(";", $strTotalIds);
    ...
    public function srvObtenerTiposServicios(&$ids, &$datos, &$cant)
    {
        $numrows=-1;
        $qry = "SELECT tipo_srv_id, tipo_srv_nombre ".
                "FROM tipo_servicio ".
                "ORDER BY tipo_srv_nombre ASC";
        $this->bdatos->connectTo();
        $link= $this->bdatos->executeQry($qry, $numrows);
        //////echo $numrows;////echo $qry;
        if($numrows>=1)
        {
            ...
            for ($i=0;$i<$numrows;$i++)
            {
                ...
                if($i==0)
                {
                    $strTotalRegistros=$passVar['tipo_srv_nombre'];
                    $strTotalIds=$passVar['tipo_srv_id'];
                }
                else
                {
                    $strTotalRegistros = $strTotalRegistros.";".$passVar['tipo_srv_nombre'];
                    $strTotalIds = $strTotalIds.";".$passVar['tipo_srv_id'];
                }
            }
            $datos = explode(";", $strTotalRegistros);
            $ids = explode(";", $strTotalIds);
    ...
    public function srvObtenerProveedores(&$ids, &$datos, &$cant)
    {
        $numrows=-1;
        $qry = "SELECT prov_id, prov_nombre ".
                "FROM proveedor ".
        ...
        if($numrows>=1)
        {
            ...
            for ($i=0;$i<$numrows;$i++)
            {
                ...
                if($i==0)
                {
                    $strTotalRegistros=$passVar['prov_nombre'];
                    $strTotalIds=$passVar['prov_id'];
                }
                else
                {
                    $strTotalRegistros = $strTotalRegistros.";".$passVar['prov_nombre'];
                    $strTotalIds = $strTotalIds.";".$passVar['prov_id'];
                }
            }
            $datos = explode(";", $strTotalRegistros);
            $ids = explode(";", $strTotalIds);
    ...
    public function srvObtenerVistaReservas(&$ids, &$tipos_serv,&$proveedores, &$ciudades, &$costos,&$descripciones, &$fecha,&$hora, &$num)
    {
        $numrows=-1;
        $qry =    "SELECT servicio_id, servicio_descripcion, servicio_costo, ".
                          "servicio_fecha, servicio_hora, ".
                          "ts.tipo_srv_nombre, p.prov_nombre, c.ciudad_nombre ".
        ...
        {            
            $strTotalIds="";
            $strTotalTiposServicio="";
            $strTotalProveedores="";
            $strTotalCiudades="";
            $strTotalDescripciones="";
            $strTotalCostos="";
            $strTotalFechas="";
            $strTotalHoras="";
            for ($i=0;$i<$numrows;$i++)
            {
                ...
                if($i==0)
                {                    
                    $strTotalIds=$passVar['servicio_id'];
                    $strTotalDescripciones=$passVar['servicio_descripcion'];
                    $strTotalCostos=$passVar['servicio_costo'];
                    $strTotalFechas=$passVar['servicio_fecha'];
                    $strTotalHoras=$passVar['servicio_hora'];
                    $strTotalTiposServicio=$passVar['tipo_srv_nombre'];
                    $strTotalProveedores=$passVar['prov_nombre'];
                    $strTotalCiudades=$passVar['ciudad_nombre'];
                }
                else
                {
                    $strTotalIds = $strTotalIds.";*".$passVar['servicio_id'];
                    $strTotalDescripciones = $strTotalDescripciones.";*".$passVar['servicio_descripcion'];
                    $strTotalCostos = $strTotalCostos.";*".$passVar['servicio_costo'];
                    $strTotalFechas = $strTotalFechas.";*".$passVar['servicio_fecha'];
                    $strTotalHoras = $strTotalHoras.";*".$passVar['servicio_hora'];
                    $strTotalTiposServicio= $strTotalTiposServicio.";*".$passVar['tipo_srv_nombre'];
                    $strTotalProveedores = $strTotalProveedores.";*".$passVar['prov_nombre'];
                    $strTotalCiudades = $strTotalCiudades.";*".$passVar['ciudad_nombre'];
                }
            }
            $ids = explode(";*", $strTotalIds);
            $tipos_serv = explode(";*", $strTotalTiposServicio);
            $proveedores= explode(";*", $strTotalProveedores);
            $ciudades= explode(";*", $strTotalCiudades);
            $descripciones=explode(";*", $strTotalDescripciones);
            $costos= explode(";*", $strTotalCostos);
            $fecha= explode(";*", $strTotalFechas);
            $hora= explode(";*", $strTotalHoras);
            $num=$numrows;
            $this->bdatos->close();
            return CodRes::EXITO;
        }
    ...
    public function srvObtenerFiltroServicios6(&$ids, &$tipos_serv,&$proveedores, &$ciudades, &$costos,&$descripciones, &$fechas,&$hora,
                                                          $tipo, $proveedor, $ciudad, $fecha, &$num)
    {
        $numrows=-1;
        $qry =    "SELECT servicio_id, servicio_descripcion, servicio_costo, ".
                          "servicio_fecha, servicio_hora, ".
                    ...
                    "WHERE ts.tipo_srv_id = s.tipo_servicio_tipo_srv_id ".
                      "AND p.prov_id = s.proveedor_prov_id ".
	              "AND c.ciudad_id = s.ciudad_ciudad_id ".
                      "AND s.tipo_servicio_tipo_srv_id = '".$tipo."' ".
                      "AND s.proveedor_prov_id = '".$proveedor."' ".
	              "AND s.ciudad_ciudad_id = '".$ciudad."' ".
	              "AND s.servicio_fecha = '".$fecha."' ".
                 "ORDER BY servicio_id ASC";
        $this->bdatos->connectTo();
        $link= $this->bdatos->executeQry($qry, $numrows);
        //echo $numrows;
    ...
    public function srvObtenerFiltroServicios5(&$ids, &$tipos_serv,&$proveedores, &$ciudades, &$costos,&$descripciones, &$fechas,&$hora,
                                                          $tipo, $proveedor, $ciudad, $fecha, &$num)
    {
        $numrows=-1;
        $qry =    "SELECT servicio_id, servicio_descripcion, servicio_costo, ".
    ...
    public function srvObtenerFiltroServicios4(&$ids, &$tipos_serv,&$proveedores, &$ciudades, &$costos,&$descripciones, &$fechas,&$hora,
                                                          $tipo, $proveedor, $ciudad, $fecha, &$num)
    {
        $numrows=-1;
        $qry =    "SELECT servicio_id, servicio_descripcion, servicio_costo, ".
    ...
    public function srvObtenerFiltroServicios3(&$ids, &$tipos_serv,&$proveedores, &$ciudades, &$costos,&$descripciones, &$fechas,&$hora,
                                                          $tipo, $proveedor, $ciudad, $fecha, &$num)
    {
        $numrows=-1;
        $qry =    "SELECT servicio_id, servicio_descripcion, servicio_costo, ".
    ...
    //-100
    public function srvObtenerFiltroServicios2(&$ids, &$tipos_serv,&$proveedores, &$ciudades, &$costos,&$descripciones, &$fechas,&$hora,
                                                          $tipo, $proveedor, $ciudad, $fecha, &$num)
    {
        $numrows=-1;
        $qry =    "SELECT servicio_id, servicio_descripcion, servicio_costo, ".
    ...
    //-10-1
    public function srvObtenerFiltroServicios1(&$ids, &$tipos_serv,&$proveedores, &$ciudades, &$costos,&$descripciones, &$fechas,&$hora,
                                                          $tipo, $proveedor, $ciudad, $fecha, &$num)
    {
        $numrows=-1;
        $qry =    "SELECT servicio_id, servicio_descripcion, servicio_costo, ".
    ...
    //-1-10
    public function srvObtenerFiltroServicios0(&$ids, &$tipos_serv,&$proveedores, &$ciudades, &$costos,&$descripciones, &$fechas,&$hora,
                                                          $tipo, $proveedor, $ciudad, $fecha, &$num)
    {
        $numrows=-1;
        $qry =    "SELECT servicio_id, servicio_descripcion, servicio_costo, ".
    ...
    //-1-1-1
    public function srvObtenerFiltroServicios7(&$ids, &$tipos_serv,&$proveedores, &$ciudades, &$costos,&$descripciones, &$fechas,&$hora,
                                                          $tipo, $proveedor, $ciudad, $fecha, &$num)
    {
        $numrows=-1;
        $qry =    "SELECT servicio_id, servicio_descripcion, servicio_costo, ".
    ...
    public function srvObtenerSecuenciaReserva(&$seq_dato, &$numrows)
    {
        $numrows=0;
        $qry = "SELECT seq_reserva_dato ".
               "  FROM secuencia_reserva ".
               " WHERE seq_reserva_id=0;";
        //echo $qry;
        if(!$this->bdatos->connectTo())
                return FALSE;
        $link= $this->bdatos->executeQry($qry, $numrows);
        ...
        {
             $passVar = $this->bdatos->_fetch_assoc($link);
             $seq_dato = $passVar['seq_reserva_dato'];
             $this->bdatos->close();
             $next=intval($seq_dato)+1;
             $this->actualizarSecuenciaReserva($next);
             return TRUE;
        }
    }
    
    private function actualizarSecuenciaReserva($next)
    {
        $numrows=-1;
        $con=0;
        $vent=-1;
        ...
        $con=1;
        $qry = "UPDATE secuencia_reserva ".
               "SET seq_reserva_dato = ".$next." ".
               "WHERE seq_reserva_id=0;";
        $link= $this->bdatos->executeQry($qry, $numrows);
        $this->bdatos->close();
        return $numrows==1?TRUE:FALSE;
    ...
    public function srvProcesarReservar($ref, $data, $numData, &$num)
    {
        $numrows=-1;
        $num=0;
        $datosReservas = explode("%%", $data);
        if(!$this->bdatos->connectTo())
                return CodRes::NO_CONNECTED;
        //echo sizeof($datosReservas);
        for($i=0;$i<sizeof($datosReservas);$i++)
        {
            $reserva = explode(";",$datosReservas[$i]);
            $fecha = explode(" ",$reserva[2]);
            $qry = "INSERT INTO reserva (servicio_servicio_id,reserva_cantidad,reserva_fecha,reserva_hora, ".
                                        "reserva_costo_u,reserva_costo_t,reserva_estado,reserva_ref) ".
                        "VALUES (".$reserva[0].", ".$reserva[1].", '".$fecha[0]."', '".$fecha[1]."', ".
                        $reserva[3].", ".$reserva[4].", 1, ".$ref.
                ");";
            //echo $qry;
            $link= $this->bdatos->executeQry($qry, $numrows);            
            $num=$num+$numrows;
        ...
        $this->bdatos->close();
        return (sizeof($datosReservas)==$num)?CodRes::EXITO:CodRes::UNKNOWN;
    }
    
    public function srvBuscarReservas($ref, &$data,&$num)
    {
        $numrows=0;
        $qry = "SELECT reserva_id, servicio_servicio_id,reserva_cantidad,reserva_fecha,reserva_hora, ".
               "       reserva_costo_u,reserva_costo_t,reserva_ref, reserva_estado ".
               "  FROM reserva ".
               " WHERE reserva_ref=".$ref." ".
               "   AND reserva_estado != 0;";
        //echo $qry;
        if(!$this->bdatos->connectTo())
                return FALSE;
        $link= $this->bdatos->executeQry($qry, $numrows);
        ...
        {            
            ...
            for ($i=0;$i<$numrows;$i++)
            {
                ...
                if($i==0)
                {          
                    $strTotalIds=$passVar['reserva_id'].";".$passVar['servicio_servicio_id'].";".$passVar['reserva_cantidad'].";".$passVar['reserva_fecha']." ".
                                $passVar['reserva_hora'].";".$passVar['reserva_costo_u'].";".
                                 $passVar['reserva_costo_t'].";".$passVar['reserva_ref'].";".$passVar['reserva_estado'];
                }
                else
                {
                    $strTotalIds=$strTotalIds."%%".$passVar['reserva_id'].";".$passVar['servicio_servicio_id'].";".$passVar['reserva_cantidad'].";".$passVar['reserva_fecha']." ".
                                $passVar['reserva_hora'].";".$passVar['reserva_costo_u'].";".
                                 $passVar['reserva_costo_t'].";".$passVar['reserva_ref'].";".$passVar['reserva_estado'];
                }
            }
    ...
    public function srvConfirmarReservas($data, $num, &$numrows)
    {        
        $numrows=-1;
        $con=0;
        $vent=-1;
        ...
        $con=1;
        $qry = "UPDATE reserva ".
               "SET reserva_estado = 2 ".
               "WHERE reserva_id IN (".$data.");";
        //echo $qry ;
        $link= $this->bdatos->executeQry($qry, $numrows);
        $this->bdatos->close();
        return $numrows==0?CodRes::SIN_REGISTROS:CodRes::EXITO;
    }
    
    public function srvBorrarReservas($data, $num, &$numrows)
    {        
        $numrows=-1;
        $con=0;
        $vent=-1;
