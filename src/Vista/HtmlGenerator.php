...
class HtmlGenerator 
{
    ...
    public function imprimirEncabezado($title)
    {
            print "<table class='basic_header' id='basic_header1' >".
            	 "<tr>".
            	 "<th class='field_logo' rowspan='5'>".
            	 "<a href='../pages/home.php'> <img src='../files/arrancar_197x51.png' width='197' height='60' alt='Arrancar.com' longdesc='../index.php' /></a>".
            	 "</th>".
 ...
 private function obtenerComboF1($id, $tiposDoc, $cantTipos, $ids_doc,$fonchange, $size)
    ...
    {
        print   "<html>";
        $this->tituloPagina("::ARRANCAR.COM::");
        print
                "<frameset cols='245px,*' frameborder='no' framespacing='0' border='0'>".
                    "<frame src='../pages/menu_lateral_arrancar.php'  scrolling='no' name='fr_menu' noresize='noresize'/>".
                    "<frameset rows='250px,*' frameborder='no' framespacing='0' border='0'>".
                        "<frameset cols='80% ,*' frameborder='no' framespacing='0' border='0'>".
                            "<frame src='../pages/propaganda.php' scrolling='no' name='fr_propaganda' noresize='noresize'/>".
                            "<frame src='../pages/encabezado.php' name='fr_encabezado' noresize='noresize'/>".       
                        "</frameset>". 
                        "<frame src='../pages/modulo_home.php' name='fr_ppal' noresize='noresize' />".
                    "</frameset>".
                "</frameset>".
                "</html>";
    }
    ...
    { 
        ...
        print "</head>";
         print "<body>".
                ...
                "<tr>".
                    "<td>".
                        "<p><a href='../forms/reserva_modulos.php'>Reservas</a></p>".
                    "</td>".
                "</tr>".
                "<tr class='alt'>".
                    "<td>".
                        "<p><a href='../forms/buscar_reserva.php'>Consultar Reserva</a></p>".
                    "</td>".
                "</tr>".                
                "<tr >".
                    "<td>".
    ...
    public function imprimirResultado($res,$msg)
    {
        ...
        print "<table class='basic_header' id='basic_header1' >"."<table class='ppal' align='center'>".
            ...
            "       <tabla>".
            "           <tr>".
            "               <td><a href='../pages/home.php' target='_top'>Ir al Home</a></td>".
            "           </tr>".
                    "</tabla>".
            "</table>".
            "  </td>".
           ...
           "<table bgcolor='lightgrey' class='ppal' align='center'>".
            ...
            "      <tr>".
                     "<th  class='field_logo' rowspan='3'>".
                        "<img src='../files/arrancar_197x51.png' width='197' height='60' alt='Inmosys'  />".
                     "</th>".
   ...
   public function imprimirModuloPropaganda($title)
    {
        $this->imprimirDoctype();
        print "<head>\n";  
        print 
	...
	"<style type=\"text/css\"> \n".
		...
		".c { clear: both; } \n".
		"#wrapper { margin: 0 auto; padding: 0 40px 60px 40px; width: 370px; } \n".
		"h2 { padding: 20px 0 10px 0; font-size: 24px; line-height: 40px; font-weight: normal; color: #adc276; text-shadow: 0 1px 3px #222222; } \n".
	"</style>\n";        
        
        $this->imprimirLinkCss("../CSS/jquery.ennui.contentslider.css");
        $this->imprimirLinkCss("../CSS/templatemo_style.css");
        $this->imprimirLinkCss("../CSS/sliderman.css");      
        $this->imprimirLinkJavascript("../libs/sliderman.1.3.7.js"); 
        print  
        "</div>\n".
        "<body style=\"background-color:#A0AB58\">\n".
        "<div align=\"center\">\n".
            "<div id=\"templatemo_slider\">\n".
                "<table align=\"center\">\n".
                    "<tr>\n".
                            ...
                            "<div id=\"wrapper\">\n".
                                ...
                                "<div id=\"slider_container_3\">\n".
                                    "<div id=\"SliderName_3\" class=\"SliderName_3\">\n".
                                        "<img src=\"../files/images/arrancar/01.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                        "<img src=\"../files/images/arrancar/02.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                        "<img src=\"../files/images/arrancar/03.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                        "<img src=\"../files/images/arrancar/04.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                        "<img src=\"../files/images/arrancar/05.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                        "<img src=\"../files/images/arrancar/06.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                        "<img src=\"../files/images/arrancar/07.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                        "<img src=\"../files/images/arrancar/08.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                        "<img src=\"../files/images/arrancar/09.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                        "<img src=\"../files/images/arrancar/10.jpg\" width=\"370\" height=\"190\" alt=\"\" title=\"\" />\n".
                                    "</div>\n".
                                    "<div class=\"c\"></div>\n".
                                    "<script type=\"text/javascript\"> \n".
                                        ...
                                        " var demoSlider_3 = Sliderman.slider({container: 'SliderName_3', width: 370, height: 190, effects: effectsDemo3, display: {autoplay: 3000}}); \n".
                                    "</script>\n".
                                    "<div class=\"c\"></div>\n".
                                    "</div>\n".
                                    "<div class=\"c\"></div>\n".
                        ...
                        "</td>\n".
                        "<td>\n".
                            "<h4>El compositor Johan Sebastian,<br>presenta en el mas antiguo recital<br> de luna llena, su actual...</h4> ".
                            "<div class=\"button\"><a href=\"#\">Leer mas...</a>"."</div> ".
                        "</td>".
                    "</tr>".
                "</table>".
            "</div>".
    ...
    public function imprimirModuloMenuLateralArrancar()
    {
        $this->imprimirDoctype();
        $this->imprimirLinkJavascript("../libs/content_slider.js");      
        print "<head>";
        $this->imprimirLinkCss("../CSS/jquery.ennui.contentslider.css");
        $this->imprimirLinkCss("../CSS/templatemo_style.css");
        print "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />";
		...
		"<div class=\"templatemo_sitebar\">".
			"<div id=\"site_title\">".
				"<h1><a href=\"../pages/modulo_home.php\" target ='fr_ppal'><img src=\"../files/images/arrancar/logoArrancar.png\" alt=\"\"  width=\"200\" height=\"53\" /></a></h1>".
			"</div>".
		"</div>".
		"<div class=\"templatemo_sidebar_bottom_01\"></div>".
		"<div class=\"templatemo_sitebar\">".
			"<ul id=\"templatemo_menu\">".
				"<li><a href=\"../pages/modulo_home.php\" target ='fr_ppal' >Inicio</a></li>".
				"<li><a href=\"../forms/reserva_modulos.php\" target ='fr_ppal'>Reservar</a></li>".
				"<li><a href=\"../forms/buscar_reserva.php\" target ='fr_ppal' >Consultar</a></li>".
				"<li><a href=\"../pages/modulo_home.php\" target ='fr_ppal' >Contacto</a></li>".
			"</ul>".
		"</div>".
		"<div class=\"templatemo_sidebar_bottom_01\"></div>".
		"<div class=\"templatemo_sitebar\">".
			"<h2>Publicidad</h2>".
			"<div class=\"news_box\">".
				"<div class=\"date\">Mayo 6, 2012</div>".
				"<p><a href=\"#\"><strong>Cena doble Hotel Inn</strong></a></p>".
				"<p>Plan especial de dia de la mujer. Vallet parking. Reserve </p>".
				"<p>y haga parte de una inolvidable velada romantica.</p>".
			"</div>".
			"<div class=\"button float_r\"><a href=\"#\">Mas...</a></div>".
    ...
    public function imprimirModuloEncabezado($title)
    {
        ...
        "</head><body>".
        "<div align='center'>".
            "<table class='basic_header' id='basic_header1' >".
                     "<tr>".
                     "<th class='field_user' >Usuario: ".
                     "</th>".
    ...
    public function imprimirMostrarFormularioReserva($idsC,$nomC, $cantC,
                                                                 $idsTS,$nomTS, $cantTS,
                                                                 $idsP, $nomP, $cantP)
    { 
        $this->imprimirDoctype();  
        $this->imprimirLinkJavascript("../libs/funciones_reserva.js");   
        $this->imprimirLinkJavascript("../libs/funciones_generales.js");        
        $this->imprimirLinkJavascript("../libs/dhtmlgoodies_calendar.js");  
        print "<head>";      
        $this->imprimirLinkJavascript("../libs/jquery.js");
        ...
        $this->imprimirLinkCss("../CSS/basic_header.css");
        print "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />";
        $this->tituloPagina("Nueva Reserva");
        print "</head>".
                "<body style='background-color:#695F61'>".
                "<form name='filtrar_reserva' method=\"POST\" target=\"fr_ppal_1\" action=\"../Vista/form_processor.php\" >".
                    "<div align='center' style='background-color:#A0AB58' >".
                        "<table class='tabla_cliente' id='tabla_cliente'>".
                            "<tr class='r2'>".
                                "<td>Tipo:</td>".
                                "<td>Ciudad:</td>".
                                "<td>Proveedor:</td>".
                            ...
                            "</tr>".
                            "<tr>".
                                "<td>".$this->obtenerComboF("nom_tipo_servicio", $nomTS, $cantTS, $idsTS,"copiarValorCampo(this,id_tipoS)")."</td>".
                                "<td>".$this->obtenerComboF("nom_ciudad", $nomC, $cantC, $idsC,"copiarValorCampo(this,id_ciudad)")."</td>".
                                "<td>".$this->obtenerComboF("nom_proveedor", $nomP, $cantP, $idsP,"copiarValorCampo(this,id_proveedor)")."</td>".
                                "<td>".
                                    "<input type='text'  id='fecha_reserva' name='fecha_reserva' readonly='readonly' value='".date("Y-m-d")."'>".
                                    "<a href=\"javascript:displayCalendar(document.getElementById('fecha_reserva'),'yyyy-mm-dd',document.getElementById('img_calendar'))\"> <img  id='img_calendar' src='../files/images/calendar.png' width='20' height='20' class='image'/></a>".
                                "</td>".
                                "<td><input  class='buts' name='buscar_filtro' id='buscar_filtro' type='button' onclick='realizar_busqueda()' value='Buscar' ></td>".
                            "</tr>".     
                        "</table>".
                    "</div>".
                "<br>".  
                "<div align='center' id='div_vis_oculta1' style='display:block'>".
                    "<iframe name=\"fr_ppal_1\" src='../views/busqueda_reserva.php' width='100%' height='500px'>".
                        "<p>Your browser does not support iframes.</p>".
                    "</iframe> ".
                "</div>".
            "<table class='hidden_items'> ".
                ...
                "</tr>".
                "<tr>".
                "        <td><input  type='text' id='form_type' name='form_type' value='filtrar_reserva' readonly='readonly'></td>".
                "        <td><input  type='text' id='id_tipoS' name='id_tipoS' value='-1' readonly='readonly'></td>".
                "        <td><input  type='text' id='id_ciudad' name='id_ciudad' value='-1' readonly='readonly'></td>".
                "        <td><input  type='text' id='id_proveedor' name='id_proveedor' value='-1' readonly='readonly'></td>".
                "        <td><input  class='but' type='submit' id='send_form' value='Submit'></td>".
                "</tr>". 
            "</table>".
            "</form>".
    ...
    public function imprimirVistaBusquedaReserva($ids, $tipos_serv, $proveedores, 
                                                 $ciudades, $costos,$descripciones, $fecha,$hora, $num)
    {
        $this->imprimirDoctype();
        $this->imprimirLinkJavascript("../libs/funciones_generales.js");
        $this->imprimirLinkJavascript("../libs/funciones_vista_cotizacion.js");
        ...
        print "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />".
            "</head>".
              "<body style='background-color:#695F61'>".
              "<form name='vista_busqueda_reserva' method=\"POST\" target=\"fr_ppal_2\" action=\"../Vista/form_processor.php\">".
                "<div align='center' style='background-color:#A0AB58'><table>"."<div align='center' >".
                "<table align='center'>".
                    "<tr>".
                        "<td colspan='2'>".
                            "<table class='tabla_cliente' id='tabla_cliente'  align='center'>". 
                                "<tr class='r2'>".
                                    "<th colspan='5'>"."<div align='left'><input  type='reset' value='Borrar' ></div>".
                                    "</th>".
                                    "<th>Total:".
                                    "</th>".
                                    "<th colspan='3'>".
                                ...
                                "<tr class='r2'>".
                                    ...
                                    "<th>Costo</th>".
                                    "<th>Cant.</th>".
                                    "<th><img src='../files/images/accept.jpg' width='20' height='20' alt='cambiar contraseña' class='image'/></th>";  
                                "</tr>";                              
                            for($i=0;$i<$num;$i++)
                            {
                                print
                                    "<tr>".
                                        "<td><input type='text' size='1' id='id_".$i."' name='id_".$i."' value='".$ids[$i]."' readonly='readonly' ></td>".
                                        "<td>".$descripciones[$i]."</td>";
                                        $date= $fecha[$i]." ".$hora[$i];
                                print   "<td><input type='text' size='15' id='fecha_".$i."' name='fecha_".$i."' value=\"".$date."\" readonly='readonly' ></td>".
                                        "<td>".$tipos_serv[$i]."</td>".
                                        "<td>".$proveedores[$i]."</td>".
                                        "<td>".$ciudades[$i]."</td>".
                                        "<td><input type='text' size='10' id='cost_".$i."' name='cost_".$i."' value='".$costos[$i]."' readonly='readonly' ></td>".
                                        "<td><input type='text' value='1' id='cant_".$i."' name='cant_".$i."' size='1' onkeypress='return soloNumeros(event)' onchange='calcularTotal()' ></td>".
                                        "<td><input type='checkbox' name='chck_".$i."' id='chck_".$i."' onchange='calcularTotal()'></td>".
                                    "</tr>";
                            }
        print               "</table>".
                ...
                "</tr>".
                "<tr>".
                    "<td><div align='right'><input type='button' name='add_service' id='add_service' onclick='adicionarCompras()'  value='Adicionar Servicio' /></div>".
                    "</td>".
                    "<td>&nbsp".
                    "</td>".
                "</tr>".               
            "</table>".
          "</div></div><br>".  
            "  <div align='center' id='div_vis_oculta2' style='display:block'>".
            "<iframe name=\"fr_ppal_2\" src='../forms/carro_compras.php' width='100%' height='250px'>".
              "<p>Your browser does not support iframes.</p>".
              "</iframe> ".
            "  </div>".         
          "<table class='hidden_items'>".
                "<tr>".
                    "<td>Total Items:<input type='text' size='1' id='total_items' name='total_items' value='".$num."'>".
                    "</td>".
                    "<td>Data:<input type='text' size='1' name='data_id' id='data_id' value=''>".
                    "</td>".                            
                    "<td><input  type='text' id='form_type' name='form_type' value='adicionar_carrito' readonly='readonly'></td>".
                    "<td colspan='2'><input  class='but' type='submit' id='send_form' value='Submit'></td>".
                "</tr>".
          "</table>".
          "</form></body></html>";
    ...
    public function imprimirReservarModulos()
    {
        print   "<html>".
                "<frameset rows='80px,*' frameborder='no' framespacing='0' border='0'>".
                        "<frame src='../forms/reserva.php'   name='fr_filtro' noresize='noresize' scrolling='no'/>".        
                        "<frame src='../views/busqueda_reserva.php'  name='fr_ppal_1' noresize='noresize' />".
                    "</frameset>".
                "</html>";
    }
    
    public function imprimirVistaServiciosEditable()
    {
        print "<div align='center' id='div_tabla_respuesta' style='display:non'>".
    ...
    public function imprimirCarritoCompras($data, $num)
    {   
        $this->imprimirDoctype();
        $this->imprimirLinkJavascript("../libs/funciones_generales.js");
        $this->imprimirLinkJavascript("../libs/funciones_reserva.js");
        ...
        $this->imprimirLinkCss("../CSS/basic_header.css");
        if($num>0)
            $datos_clientes= explode("%%",$data);
        print "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />".
            "</head>".
              "<body style='background-color:#695F61'>".  
                "<form name='form_reservar_servicios' method=\"POST\" action=\"../Vista/form_processor.php\">".
                "<div align='center' style='background-color:#A0AB58'><table>"."<div align='center' >".
                        "<table align='center'>".
                            "<tr>".
                                "<td colspan='2'>".
                                    "<table class='tabla_cliente' id='tabla_cliente'  align='center'>".
                                        "<tr class='r2'>".                
                                            "<th colspan='7'><div align='center'>MI CARRITO DE RESERVAS</div></th>".
                                        "</tr>". 
                                        "<tr class='r2'>".        
                                            "<th colspan='5'>"."<div align='left'><input  type='reset' value='Borrar' ></div>".
                                            "</th>".
                                            "<th colspan='2'>".
                                                "Total:<input type='text' readonly='readonly' id='total_cotizacionR' name='total_cotizacionR' value='0'>".
                                            "</th>".
                                        "</tr>". 
                                        "<tr class='r2'>".
                                            "<th>Id.</th>".
                                            ...
                                            "<th>Costo Total</th>".  
                                            "<th><img src='../files/images/accept.jpg' width='20' height='20' alt='' class='image'/></th>";  
                                        "</tr>";
                                        for($i=0;$num>0 && $i<sizeof($datos_clientes);$i++)
                                        {
                                            $cliente = explode(";", $datos_clientes[$i]);
                                            print "<tr>";
                                            for($j=0;$j<sizeof($cliente);$j++)
                                            {
                                                if($j==0)
                                                    print "<td>".($i+1)."</td>"."<td><input type='text' size='15' id='servicio_".$i."' name='servicio_".$i."' value=\"".$cliente[$j]."\" /></td>";
                                                else if($j==1)
                                                    print "<td><input type='text' size='15' id='cant_".$i."' name='cant_".$i."' value=\"".$cliente[$j]."\" /></td>";
                                                else if($j==2)
                                                    print "<td><input type='text' size='15' id='fecha_".$i."' name='fecha_".$i."' value=\"".$cliente[$j]."\" /></td>";
                                                else if($j==3)
                                                    print "<td><input type='text' size='15' id='costou_".$i."' name='costou_".$i."' value=\"".$cliente[$j]."\" /></td>";
                                                else if($j==4)
                                                    print "<td><input type='text' size='15' id='costot_".$i."' name='costot_".$i."' value=\"".$cliente[$j]."\" /></td>";
                                            }
                                                    print "<td><input type='checkbox' name='chck_".$i."' id='chck_".$i."' onchange='calcularTotalServicios()'></td>".
                                                   "</tr>";
                                        }  
                                        
                                        print       "<tr>".
                                                        "<td colspan='7'>".
                                                            "<div align='right'><input type='button' onclick='reservar()' name='Reservar' id='Reservar' value='Reservar' ></div>".
                                                        "</td>".
                                                    "</tr>".
                              "</table>".
                            "</td>".
          ...
          "<table class='hidden_items'>".
                "<tr>".
                    "<td>Total Items:<input type='text' size='1' id='total_servicios' name='total_servicios' value='".(isset ($datos_clientes)?sizeof($datos_clientes):0)."'>".
                    "</td>".
                    "<td>Data:<input type='text' size='1' name='dataR_id' id='dataR_id' value=''>".
                    "</td>".                            
                    "<td><input  type='text' id='form_type' name='form_type' value='form_reservar_servicios' readonly='readonly'></td>".
                    "<td colspan='2'><input  class='but' type='submit' id='send_form' value='Submit'></td>".
                "</tr>".
          "</table>".
           "</body></html>";; 
    ...
    public function imprimirMostrasBuscarReserva()
    {
        $this->imprimirDoctype();  
        $this->imprimirLinkJavascript("../libs/funciones_reserva.js");   
        $this->imprimirLinkJavascript("../libs/funciones_generales.js");   
        ...
        $this->imprimirLinkCss("../CSS/basic_header.css");
        print "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />";
        $this->tituloPagina("Buscar Reserva");
        print "</head>".
                "<body style='background-color:#695F61'>".
                "<form name='buscar_reserva' method=\"POST\" target=\"fr_ppal_1\" action=\"../Vista/form_processor.php\" >".
                    "<div align='center' style='background-color:#A0AB58' >".
                        "<table class='tabla_cliente' id='tabla_cliente'>".
                            "<tr class='r2'>".
                            ...
                            "<tr>".
                                "<td>".
                                    "<input type='text'  id='codigo_reserva' name='codigo_reserva'  onkeypress='return soloNumeros(event)' value=''>".
                                "</td>".
                                "<td><input  class='buts' name='buscar_reserva' id='buscar_reserva' type='button' onclick='realizar_busqueda_reserva()' value='Buscar Reserva' ></td>".
                            "</tr>".     
                        "</table>".
                    "</div>".
                "<br>".  
                "<div align='center' id='div_vis_oculta1' style='display:block'>".
                    "<iframe name=\"fr_ppal_1\" src='../forms/carro_comprasS.php' width='100%' height='500px'>".
                        "<p>Your browser does not support iframes.</p>".
                    "</iframe> ".
                "</div>".
            "<table class='hidden_items'> ".
                ...
                "</tr>".
                "<tr>".
                "        <td><input  type='text' id='form_type' name='form_type' value='buscar_reserva' readonly='readonly'></td>".
                "        <td><input  class='but' type='submit' id='send_form' value='Submit'></td>".
                "</tr>". 
            "</table>".
            "</form>".
    ...
    public function imprimirCarritoComprasS($data, $num)
    {   
        $this->imprimirDoctype();
        $this->imprimirLinkJavascript("../libs/funciones_generales.js");
        $this->imprimirLinkJavascript("../libs/funciones_reserva.js");
        ...
        print "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />".
                        ...
                        "<table align='center'>".
                            "<tr>".
                                "<td colspan='2'>".
                                    "<table class='tabla_cliente' id='tabla_cliente'  align='center'>".
                                        "<tr class='r2'>".                
                                            "<th colspan='10'><div align='center'>MIS RESERVAS</div></th>".
                                        "</tr>". 
                                        "<tr class='r2'>".        
                                            "<th colspan='7'>"."<div align='left'><input  type='reset' value='Borrar' ></div>".
                                            "</th>".
                                            "<th colspan='3'>".
                                                "Total:<input type='text' readonly='readonly' id='total_cotizacionR' name='total_cotizacionR' value='0'>".
                                            "</th>".
                                        ...
                                        "<tr class='r2'>".
                                            ...
                                            "<th>Estado</th>".   
                                            "<th><img src='../files/images/accept.jpg' width='20' height='20' alt='cambiar contraseña' class='image'/></th>". 
                                            "<th><img src='../files/images/delete.gif' width='20' height='20' alt='cambiar contraseña' class='image'/></th>";  
                                        "</tr>";
                                        for($i=0;$num>0 && $i<sizeof($datos_clientes);$i++)
                                        {
                                            $cliente = explode(";", $datos_clientes[$i]);
                                            ...
                                            for($j=0;$j<sizeof($cliente);$j++)
                                            {
                                                //$dataF = explode(" ",$cliente[2]);
                                                if($j==0)
                                                    print "<td><input type='text' size='2' id='servicio_".$i."' name='servicio_".$i."' value=\"".$cliente[$j]."\" readonly='readonly' /></td>";                                                
                                                else if($j==5) 
                                                    print "<td><input type='text' size='10' id='costot_".$i."' name='costot_".$i."' value=\"".$cliente[$j]."\" readonly='readonly' /></td>";                                                
                                                else if($j==7) 
                                                    print "<td>".($cliente[$j]==1?"Reservado":($cliente[$j]==2?"Confirmado":"Facturado"))."</td>";                                                
                                                else     
                                                    print "<td>".$cliente[$j]."</td>";
                                            }
                                            print "<td><input type='checkbox' name='chck_".$i."' id='chck_".$i."' onchange='calcularTotalServicios()' ";
                                            print ($cliente[7]==1)?"></td>":"readonly></td>";
                                            print "<td><input type='checkbox' name='chckd_".$i."' id='chckd_".$i."' onchange='calcularDataDelete()' ";
                                            print ($cliente[7]==1)?"></td>":"readonly></td>";
                                            print "</tr>";
                                        }  
                                        ...
                                        print       "<tr>".
                                                        "<td colspan='10'>".
                                                            "<div align='right'><input type='button' onclick='confirmar_reserva()' name='conf_reserva' id='conf_reserva' value='Confirmar Reserva' >".
                                                            "<input type='button' onclick='borrar_reserva()' name='del_reserva' id='del_reserva' value='Borrar Reserva' ></div>".
                                                        "</td>".
                                                    "</tr>".
                              "</table>".
                            "</td>".
          ...
          "<table class='hidden_items'>".
                "<tr>".
                    "<td>Total Items:<input type='text' size='1' id='total_servicios' name='total_servicios' value='".(isset ($datos_clientes)?sizeof($datos_clientes):0)."'>".
                    "</td>".
                    "<td>DataC:<input type='text' size='1' name='dataC_id' id='dataC_id' value='' />".
                    "</td>".     
                    "<td>DataD:<input type='text' size='1' name='dataD_id' id='dataD_id' value='' />".
                    "</td>". 
                    "</td>".     
                    "<td>Tarea:<input type='text' size='1' name='tarea_id' id='tarea_id' value='' />".
                    "</td>". 
                    "<td><input  type='text' id='form_type' name='form_type' value='form_confirmar_reservas' readonly='readonly' /></td>".
                    "<td colspan='2'><input  class='but' type='submit' id='send_form' value='Submit' /></td>".
                "</tr>".
          "</table>".
           "</body></html>"; 
