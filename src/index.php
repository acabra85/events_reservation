<?php
	...
	if (isset($_GET['msg']))
	{
		...
		else if(($_GET['msg'])== 'act_lock')
			echo("Error: error usuario bloqueado");
                    ...
                    <div align="center">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><span style='color:black'><b>Usuario:</b></span></td>
                            ...
                            <tr>
                                ...
                                <td><span style='color:black'><b>Password:</b></span></td>
